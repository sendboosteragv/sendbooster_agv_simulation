...
def generate_launch_description():
    launch_file_dir = os.path.join(get_package_share_directory('sendbooster_agv_simulation'), 'launch')
    ...
    world = os.path.join(
        get_package_share_directory('sendbooster_agv_simulation'),
        'worlds',
        'sendbooster_agv_world.world'
    )
